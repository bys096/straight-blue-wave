          ...
          <ul id="sidebarnav" >
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="./ui-card.html" aria-expanded="false">
                ...
                <span class="hide-menu">Team1</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./ui-card.html" aria-expanded="false">
                ...
                <span class="hide-menu">Team2</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./ui-card.html" aria-expanded="false">
                ...
                <span class="hide-menu">Team3</span>
              </a>
            </li>
            {/* <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <li class="sidebar-item">
                ...
                <span class="hide-menu">Project1</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./ui-forms.html" aria-expanded="false">
                ...
                <span class="hide-menu">Project2</span>
              </a>
            </li>
            <li class="sidebar-item">
              <a class="sidebar-link" href="./ui-forms.html" aria-expanded="false">
                ...
                <span class="hide-menu">Project3</span>
              </a>
            </li>
